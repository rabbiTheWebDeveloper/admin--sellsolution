...
const Login = () => {
  ...
  const onSubmit = (data) => {
    fetch("https://api.salesolutionbd.com/api/v1/login", {
      method: "POST",
      headers: {
    ...
    //   console.log(data);
    //   // if(data.insertedId){
    //   //   alert('Reg processed Successfully');
    //   //   reset()
    //   // }
    //   reset()
    // })
              ...
              <div className="text">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="custome_input">
                    ...
                    <input {...register("password", { required: true })} type="text" placeholder="Enter Password here" />
                  </div>
                  {/* Submit */}
                  <div className="custome_input">
